...
# Test the function
# test_2024 <- scrape_revision_year(2024)
# print(test_2024)

# Test the function
# test_2020 <- scrape_revision_year(2020)
# print(test_2020)
...
```
Though the period following COVID does not provide us with as many months of data to look at as before, we do have over 30 months to work with. As we can see, there does seem to be a statistically significant difference between the periods: revisions have been lower. We can reject the null hypothesis.
...
```
As you can see, 73,000 is a fairly typical value. So Trump may well have been shocked by this number, but there is nothing inherently shocking about it. This claim is **FALSE**.

![](https://static.politifact.com/politifact/rulings/meter-false.jpg){width="50%"}

In fairness, the number may have been considered shocking due to the size of the revision rather than the value itself.
...
![](https://static.politifact.com/politifact/rulings/meter-half-true.jpg){width="50%"}
